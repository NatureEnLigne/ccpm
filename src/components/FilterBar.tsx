      ...
      <div className="flex items-center justify-between gap-4 min-h-[72px]">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          <input
            ...
            className="rounded-xl border border-amber-200/50 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:border-primary-500/50 font-medium w-36"
            style={{
              background: 'linear-gradient(135deg, rgba(205, 133, 63, 0.1), rgba(45, 80, 22, 0.1))',
              color: '#cd853f'
            }}
